...
var $$Schema = t.recursion("$$Schema", function () {
    return t.partial({
        ...
        items: t.union([
            $Reference,
            $Schema,
            t.array(t.union([$Reference, $Schema]))
        ]),
...
var $MediaType = t.recursion("$MediaType", function () { return t.union([$Schema, $$MediaType]); });
    ...
    return t.intersection([
        ...
        t.partial({
            ...
            parameters: t.union([
                $LazyParams,
                $LazyLazyParams,
                t.array(t.union([$Reference, $Parameter]))
            ]),
...
var $SimpleBooleanSchema = t.boolean;
var $SimpleIntegerSchema = t.number;
var $SimpleNumberSchema = t.number;
var $SimpleStringSchema = t.string;
var $SimpleArraySchema = t.array(t.any);
var $SimpleObjectSchema = t.any;
...
var $RequestBody = t.union([$MediaType, $$RequestBody]);
...
var $Responses = t.union([$Response, $$Responses]);
var $LazyLazyParams = t.record(t.string, $Schema);
var $LazyParams = t.partial({
    query: $LazyLazyParams,
    header: $LazyLazyParams,
    path: $LazyLazyParams,
    cookie: $LazyLazyParams
});
var $SecurityRequirement = t.record(t.string, t.array(t.string));
var $Operation = t.union([$Responses, $$Operation]);
...
var $PathItem = t.union([$Operation, $$PathItem]);
...
exports.is$Reference = function (u) { return $Reference.is(u); };
exports.is$Info = function (u) {
    return $Info.is(u) &&
        new Set(__spread([
            "title",
            "description",
...
exports.is$Components = function (u) {
...
exports.is$Discriminator = function (u) {
    return $Discriminator.is(u);
};
exports.is$XML = function (u) {
    return $XML.is(u) &&
        new Set(__spread(["name", "namespace", "prefix", "attribute", "wrapped"], Object.keys(u).filter(function (i) { return i.slice(0, 2) !== "x-"; }))).size === 5;
};
exports.is$Response = function (u) { return $Response.is(u); };
exports.is$$Response = function (u) {
...
exports.is$Schema = function (u) { return $Schema.is(u); };
exports.is$$Schema = function (u) {
    return $$Schema.is(u) &&
        new Set(__spread([
            "title",
            "multipleOf",
...
exports.is$SimpleObjectSchema = function (u) {
    return $SimpleObjectSchema.is(u);
};
exports.is$SimpleIntegerSchema = function (u) {
    return $SimpleIntegerSchema.is(u);
};
exports.is$SimpleNumberSchema = function (u) {
    return $SimpleNumberSchema.is(u);
};
exports.is$SimpleStringSchema = function (u) {
    return $SimpleStringSchema.is(u);
};
exports.is$SimpleBooleanSchema = function (u) {
    return $SimpleBooleanSchema.is(u);
};
exports.is$SimpleArraySchema = function (u) {
    return $SimpleArraySchema.is(u);
};
exports.is$MediaType = function (u) { return $MediaType.is(u); };
exports.is$$MediaType = function (u) {
...
exports.is$Paths = function (u) { return $Paths.is(u); };
exports.is$LazyLazyParams = function (u) {
    return $LazyLazyParams.is(u);
};
exports.is$LazyParams = function (u) {
    return $LazyParams.is(u);
};
exports.is$PathItem = function (u) { return $PathItem.is(u); };
exports.is$$PathItem = function (u) {
...
exports.is$Operation = function (u) { return $Operation.is(u); };
exports.is$$Operation = function (u) {
...
exports.is$Responses = function (u) { return $Responses.is(u); };
exports.is$$Responses = function (u) {
...
exports.is$ExampleXORExamples = function (u) {
    return $ExampleXORExamples.is(u);
};
exports.is$SchemaXORContent = function (u) {
    return $SchemaXORContent.is(u);
};
exports.is$Parameter = function (u) {
...
exports.is$ParameterLocation = function (u) {
    return $ParameterLocation.is(u);
};
exports.is$RequestBody = function (u) {
...
exports.is$SecurityScheme = function (u) {
    return $SecurityScheme.is(u);
};
exports.is$APIKeySecurityScheme = function (u) {
...
exports.is$HTTPSecurityScheme = function (u) {
...
exports.is$OAuth2SecurityScheme = function (u) {
...
exports.is$OpenIdConnectSecurityScheme = function (u) {
...
exports.is$OAuthFlows = function (u) {
...
exports.is$ImplicitOAuthFlow = function (u) {
...
exports.is$PasswordOAuthFlow = function (u) {
...
exports.is$ClientCredentialsFlow = function (u) {
    return $ClientCredentialsFlow.is(u) &&
        new Set(__spread(["tokenUrl", "refreshUrl", "scopes"], Object.keys(u).filter(function (i) { return i.slice(0, 2) !== "x-"; }))).size === 3;
};
exports.is$AuthorizationCodeOAuthFlow = function (u) {
...
exports.is$Callback = function (u) { return $Callback.is(u); };
exports.is$Encoding = function (u) { return $Encoding.is(u); };
exports.is$OpenAPIObject = function (u) {
