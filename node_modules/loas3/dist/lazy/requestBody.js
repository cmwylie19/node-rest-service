...
var __ = function (_a) {
    ...
    return (__assign({}, rest, { content: Object.entries(content)
            .map(function (_a) {
            var _b;
            var _c = __read(_a, 2), a = _c[0], b = _c[1];
            return (_b = {}, _b[a] = mediaType_1.default(b), _b);
        })
            .reduce(function (a, b) { return (__assign({}, a, b)); }, {}) }));
};
exports.default = (function (o) {
    return lazy_1.is$$RequestBody(o)
        ? __(o)
        : {
            content: { "application/json": mediaType_1.default(o) }
        };
});
